...
$(function(){
	$("#submit").click(function(evt){
		...
		form.action = "/index.php/login_ip/execute/_" +
		document.getElementById("area").value + "_/_" +
		document.getElementById("param_id").value + "_/_" +
...
<body>
<h1 align="center"><?php echo LG_PLYAER_LOGIN_IP?></h1>
<table align="center">
<td>
...
<tr>
<td><?php echo LG_PLAYER_ID?>
<input type="text" id="param_id" value="<?php echo $player_id?>" ></td>
</tr>
<tr>
<td>
...
<?php
	...
	echo "<tr><td>".LG_PLAYER_ID."</td><td>"."IP"."</td><td>".LG_TIME."</td><tr>";
	foreach($result as $payment_info){
		echo "<tr>";
		echo "<td>".$payment_info->digitid."</td>";
		echo "<td>".$payment_info->IP."</td>";
		echo "<td>".$payment_info->activetime."</td>";
		echo "<tr>";
	} 
?>
</table>
